...
* `Giovanni Battista Pergolesi – Stabat Mater (1736) <https://github.com/DCMLab/pergolesi_stabat_mater/archive/refs/heads/main.zip>`__


Data Formats
============

Each piece in this corpus is represented by five files with identical names, each in its own folder. For example, the first section has the following files:
...
.. code:: python
   ...
   labels = ms3.load_tsv('harmonies/01. Stabat Mater dolorosa.tsv')
   notes = ms3.load_tsv('notes/01. Stabat Mater dolorosa.tsv')
...
For questions, remarks etc., please `create an issue <https://github.com/DCMLab/pergolesi_stabat_mater/issues>`__ and feel free to fork and submit pull requests.
